...
namespace Gov.Jag.PillPressRegistry.Interfaces.Models
{
    ...
    public partial class MicrosoftDynamicsCRMknowledgearticle
    {
        ...
        public IList<MicrosoftDynamicsCRMaccount> MsdynAccountKnowledgearticle { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "msdyn_bcgov_customaddress_knowledgearticle")]
        public IList<MicrosoftDynamicsCRMbcgovCustomaddress> MsdynBcgovCustomaddressKnowledgearticle { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "msdyn_bcgov_inspectionownershipcategory_knowledgearticle")]
        public IList<MicrosoftDynamicsCRMbcgovInspectionownershipcategory> MsdynBcgovInspectionownershipcategoryKnowledgearticle { get; set; }
