...
namespace Gov.Jag.PillPressRegistry.Interfaces.Models
{
    ...
    public partial class MicrosoftDynamicsCRMincident
    {
        ...
        public MicrosoftDynamicsCRMincident(bool? bcgovDoyouassembleforotherbusinesses = default(bool?), string bcgovNameofbusinessthathasrentedorleased = default(string), string _bcgovOriginatingsellersaddressValue = default(string), int? statuscode = default(int?), System.DateTimeOffset? followupby = default(System.DateTimeOffset?), object entityimage = default(object), int? bcgovPillpressencapsulatorsize = default(int?), string _slainvokedidValue = default(string), double? influencescore = default(double?), bool? bcgovSerialnumberforcustombuilt = default(bool?), string _bcgovApplicationtypeidValue = default(string), string _kbarticleidValue = default(string), string bcgovMainbusinessfocus = default(string), bool? bcgovConsentforemailcorrespondence = default(bool?), string bcgovBcsellerscontactemail = default(string), string _bcgovImportersaddressValue = default(string), string _contactidValue = default(string), bool? bcgovSellequipment = default(bool?), bool? bcgovIncompletecycle3 = default(bool?), string bcgovCustombuiltserialnumber = default(string), System.DateTimeOffset? bcgovSitelicenceexpirydate = default(System.DateTimeOffset?), string _createdbyexternalpartyValue = default(string), int? actualserviceunits = default(int?), long? versionnumber = default(long?), string entityimageUrl = default(string), bool? bcgovAreyouaregisteredseller = default(bool?), int? bcgovOutsidebcsellerslocation = default(int?), string processid = default(string), string _firstresponsebykpiidValue = default(string), bool? bcgovIntendtopurchaseequipment = default(bool?), bool? bcgovAlternativeownershiparrangement = default(bool?), string bcgovEmailofbusinessthathasrentedorleased = default(string), string _modifiedonbehalfbyValue = default(string), string _masteridValue = default(string), System.DateTimeOffset? createdon = default(System.DateTimeOffset?), string _transactioncurrencyidValue = default(string), string bcgovAdditionalbusinessinformationaboutseller = default(string), bool? bcgovIntendtosellpharmaceuticalmixerorblender = default(bool?), int? billedserviceunits = default(int?), string bcgovHowcameintopossessionother = default(string), System.DateTimeOffset? bcgovDrugestablishmentlicenceexpirydate = default(System.DateTimeOffset?), string bcgovOutsidebcsellersname = default(string), string bcgovSerialnumberkeypartdescription = default(string), string _primarycontactidValue = default(string), int? bcgovOriginatingsellerslocation = default(int?), bool? decremententitlementterm = default(bool?), string bcgovWheredidyouobtainparts = default(string), bool? customercontacted = default(bool?), bool? bcgovComplete = default(bool?), bool? bcgovBorrowrentleaseequipment = default(bool?), int? bcgovLevelofequipmentautomation = default(int?), string _modifiedbyexternalpartyValue = default(string), string bcgovIntendtosellother = default(string), string bcgovEmailofthebusinessthathasgivenorloaned = default(string), string title = default(string), int? caseorigincode = default(int?), string _owningbusinessunitValue = default(string), string bcgovManufacturingprocessdescription = default(string), bool? bcgovAllownermanagerscreeningconsentsreceived = default(bool?), bool? isescalated = default(bool?), string bcgovDelbusinessname = default(string), string bcgovOtherlicence = default(string), System.DateTimeOffset? lastonholdtime = default(System.DateTimeOffset?), System.DateTimeOffset? bcgovDateofpurchasefrombcseller = default(System.DateTimeOffset?), string bcgovPersonbusinessthatbuiltequipment = default(string), int? bcgovEncapsulatormaxcapacity = default(int?), bool? bcgovConfirmationofauthorizeduse = default(bool?), int? servicestage = default(int?), int? numberofchildincidents = default(int?), bool? bcgovProvidingmanufacturingtoothers = default(bool?), string _customeridValue = default(string), string bcgovEquipmenttypeother = default(string), string bcgovPillpressencapsulatorsizeother = default(string), System.DateTimeOffset? modifiedon = default(System.DateTimeOffset?), bool? bcgovPillpressencapsulatorsizeothercheck = default(bool?), bool? bcgovIntendtoselldiemouldorpunch = default(bool?), bool? bcgovDeclarationofcorrectinformation = default(bool?), string bcgovDrugestablishmentlicencenumber = default(string), bool? bcgovOwnedbeforejan2019 = default(bool?), bool? bcgovHowcameintopossessionothercheck = default(bool?), bool? bcgovIntendonsellingequipmenttoothers = default(bool?), string _bcgovEquipmentrecordValue = default(string), bool? bcgovIncomplete = default(bool?), string _createdbyValue = default(string), bool? bcgovGivenorloanedtome = default(bool?), System.DateTimeOffset? bcgovDateofpurchasefromimporter = default(System.DateTimeOffset?), string _modifiedbyValue = default(string), string _contractdetailidValue = default(string), int? incidentstagecode = default(int?), string _entitlementidValue = default(string), bool? bcgovTypeofsellerothercheck = default(bool?), string bcgovNameofbcseller = default(string), string _parentcaseidValue = default(string), string stageid = default(string), string bcgovImportersregistrationnumber = default(string), bool? bcgovIassembleditmyself = default(bool?), bool? bcgovKindsofproductsnaturalhealthproducts = default(bool?), bool? bcgovIntendtosellpillpress = default(bool?), System.DateTimeOffset? bcgovSubmitteddate = default(System.DateTimeOffset?), bool? bcgovManufacturerofcontrolledequipment = default(bool?), int? customersatisfactioncode = default(int?), string bcgovLegislativeauthorityother = default(string), string bcgovSitelicencenumber = default(string), bool? checkemail = default(bool?), string productserialnumber = default(string), string bcgovNameofmanufacturer = default(string), int? firstresponseslastatus = default(int?), int? timezoneruleversionnumber = default(int?), string _productidValue = default(string), int? bcgovEquipmenttype = default(int?), System.DateTimeOffset? bcgovDateofpurchasefromoutsidebcseller = default(System.DateTimeOffset?), bool? bcgovFoodanddrugact = default(bool?), bool? bcgovBcgovLegislativeauthorityothercheck = default(bool?), bool? bcgovPurchasedfrombcseller = default(bool?), string _bcgovAddressofbusinessthathasgivenorloanedValue = default(string), bool? bcgovIntendonrentingleasingtoothers = default(bool?), int? onholdtime = default(int?), bool? bcgovOtherlicencecheck = default(bool?), System.DateTimeOffset? resolveby = default(System.DateTimeOffset?), string _owninguserValue = default(string), bool? routecase = default(bool?), System.DateTimeOffset? bcgovWhendidyouassembleequipment = default(System.DateTimeOffset?), bool? isdecrementing = default(bool?), string _slaidValue = default(string), bool? activitiescomplete = default(bool?), int? messagetypecode = default(int?), string _contractidValue = default(string), bool? bcgovOnetimesellerofowncontrolledequipment = default(bool?), bool? bcgovKindsofproductsdrugs = default(bool?), string bcgovNameofimporter = default(string), bool? bcgovProducingownproduct = default(bool?), string _subjectidValue = default(string), string _owningteamValue = default(string), string description = default(string), bool? bcgovDrugestablishmentlicence = default(bool?), bool? bcgovIntendtosellencapsulator = default(bool?), string bcgovOtherlicencebusinessname = default(string), string bcgovDetailsofassemblyforotherbusinesses = default(string), int? contractservicelevelcode = default(int?), string entityimageid = default(string), int? severitycode = default(int?), bool? merged = default(bool?), string bcgovTypeofsellerother = default(string), string _bcgovAssociatedequipmentrecordValue = default(string), int? bcgovPillpressmaxcapacity = default(int?), bool? bcgovIncompletecycle2 = default(bool?), string bcgovHowequipmentbuiltdescription = default(string), string incidentid = default(string), string _bcgovAddressofbusinessthathasrentedorleasedValue = default(string), bool? bcgovOwnintendtoownequipmentforbusinessuse = default(bool?), string bcgovPhoneofbusinessthathasgivenorloaned = default(string), string traversedpath = default(string), bool? bcgovPossessuntilicansell = default(bool?), int? bcgovHowwasequipmentbuilt = default(int?), string _accountidValue = default(string), int? utcconversiontimezonecode = default(int?), bool? bcgovKindsofproductothercheck = default(bool?), string bcgovSerialnumber = default(string), string bcgovHowwasequipmentbuiltother = default(string), int? casetypecode = default(int?), bool? bcgovOwnusepossesstoproduceaproduct = default(bool?), bool? bcgovPurchasedfromselleroutsideofbc = default(bool?), bool? bcgovHowwasequipmentbuiltothercheck = default(bool?), bool? bcgovRentingorleasingfromanotherbusiness = default(bool?), long? entityimageTimestamp = default(long?), string _bcgovAddressofpersonbusinessValue = default(string), string bcgovBcsellerscontactphonenumber = default(string), bool? followuptaskcreated = default(bool?), string bcgovKindofalternateownershipother = default(string), string _owneridValue = default(string), string bcgovNameoforiginatingseller = default(string), string bcgovWhyhaveyouacceptedorborrowed = default(string), string bcgovKindsofproductsother = default(string), System.DateTimeOffset? overriddencreatedon = default(System.DateTimeOffset?), bool? bcgovFoippaconsent = default(bool?), string bcgovExplanationofequipmentuse = default(string), bool? firstresponsesent = default(bool?), bool? bcgovSitelicence = default(bool?), int? prioritycode = default(int?), bool? bcgovCurrentlyownusepossessequipment = default(bool?), string ticketnumber = default(string), bool? bcgovRetailerofcontrolledequipment = default(bool?), string bcgovSitelicencebusinessname = default(string), string _existingcaseValue = default(string), bool? bcgovIntendtosellothercheck = default(bool?), string _bcgovSubmitterValue = default(string), string bcgovWhyhaveyourentedorleased = default(string), string bcgovBcsellersregistrationnumber = default(string), string bcgovEquipmentmake = default(string), bool? bcgovImportedtobcbyathirdparty = default(bool?), string _socialprofileidValue = default(string), int? statecode = default(int?), object exchangerate = default(object), System.DateTimeOffset? responseby = default(System.DateTimeOffset?), System.DateTimeOffset? escalatedon = default(System.DateTimeOffset?), string _bcgovEquipmentlocationValue = default(string), bool? bcgovKindofalternateownershipothercheck = default(bool?), string _bcgovBcsellersaddressValue = default(string), int? resolvebyslastatus = default(int?), int? importsequencenumber = default(int?), string bcgovNameofbusinessthathasgivenorloaned = default(string), string bcgovEquipmentmodel = default(string), string bcgovDetailsofhowequipmentcameintopossession = default(string), bool? blockedprofile = default(bool?), string _bcgovRelatedapplicationsidValue = default(string), string _createdonbehalfbyValue = default(string), double? sentimentvalue = default(double?), System.DateTimeOffset? bcgovOtherlicenceexpirydate = default(System.DateTimeOffset?), string _bcgovOutsidebcsellersaddressValue = default(string), string bcgovOtherlicencenumber = default(string), bool? bcgovUsingtomanufactureaproduct = default(bool?), string _resolvebykpiidValue = default(string), string bcgovPhoneofbusinessthathasrentedorleased = default(string), IList<MicrosoftDynamicsCRMpostregarding> incidentPostRegardings = default(IList<MicrosoftDynamicsCRMpostregarding>), IList<MicrosoftDynamicsCRMpostfollow> incidentPostFollows = default(IList<MicrosoftDynamicsCRMpostfollow>), MicrosoftDynamicsCRMincident masterid = default(MicrosoftDynamicsCRMincident), IList<MicrosoftDynamicsCRMincident> incidentMasterIncident = default(IList<MicrosoftDynamicsCRMincident>), IList<MicrosoftDynamicsCRMlead> originatingCaseLead = default(IList<MicrosoftDynamicsCRMlead>), MicrosoftDynamicsCRMincident parentcaseid = default(MicrosoftDynamicsCRMincident), IList<MicrosoftDynamicsCRMincident> incidentParentIncident = default(IList<MicrosoftDynamicsCRMincident>), MicrosoftDynamicsCRMsystemuser modifiedonbehalfby = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMactivityparty> incidentActivityParties = default(IList<MicrosoftDynamicsCRMactivityparty>), MicrosoftDynamicsCRMsla slainvokedidSla = default(MicrosoftDynamicsCRMsla), MicrosoftDynamicsCRMtransactioncurrency transactioncurrencyid = default(MicrosoftDynamicsCRMtransactioncurrency), IList<MicrosoftDynamicsCRMsocialactivity> incidentSocialActivities = default(IList<MicrosoftDynamicsCRMsocialactivity>), MicrosoftDynamicsCRMslakpiinstance firstresponsebykpiid = default(MicrosoftDynamicsCRMslakpiinstance), MicrosoftDynamicsCRMsla slaidSla = default(MicrosoftDynamicsCRMsla), MicrosoftDynamicsCRMproduct productid = default(MicrosoftDynamicsCRMproduct), IList<MicrosoftDynamicsCRMslakpiinstance> slakpiinstanceIncident = default(IList<MicrosoftDynamicsCRMslakpiinstance>), IList<MicrosoftDynamicsCRMactioncard> incidentActioncard = default(IList<MicrosoftDynamicsCRMactioncard>), IList<MicrosoftDynamicsCRMappointment> incidentAppointments = default(IList<MicrosoftDynamicsCRMappointment>), IList<MicrosoftDynamicsCRMconnection> incidentConnections2 = default(IList<MicrosoftDynamicsCRMconnection>), IList<MicrosoftDynamicsCRMserviceappointment> incidentServiceAppointments = default(IList<MicrosoftDynamicsCRMserviceappointment>), MicrosoftDynamicsCRMteam owningteam = default(MicrosoftDynamicsCRMteam), MicrosoftDynamicsCRMcontractdetail contractdetailid = default(MicrosoftDynamicsCRMcontractdetail), MicrosoftDynamicsCRMincident existingcase = default(MicrosoftDynamicsCRMincident), IList<MicrosoftDynamicsCRMincident> incidentExistingcase = default(IList<MicrosoftDynamicsCRMincident>), IList<MicrosoftDynamicsCRMqueueitem> incidentQueueItem = default(IList<MicrosoftDynamicsCRMqueueitem>), IList<MicrosoftDynamicsCRMknowledgebaserecord> knowledgeBaseRecordIncident = default(IList<MicrosoftDynamicsCRMknowledgebaserecord>), IList<MicrosoftDynamicsCRMphonetocaseprocess> incidentPhonetocaseprocess = default(IList<MicrosoftDynamicsCRMphonetocaseprocess>), IList<MicrosoftDynamicsCRMincidentresolution> incidentIncidentResolutions = default(IList<MicrosoftDynamicsCRMincidentresolution>), IList<MicrosoftDynamicsCRMemail> incidentEmails = default(IList<MicrosoftDynamicsCRMemail>), MicrosoftDynamicsCRMprocessstage stageidProcessstage = default(MicrosoftDynamicsCRMprocessstage), IList<MicrosoftDynamicsCRMasyncoperation> incidentAsyncOperations = default(IList<MicrosoftDynamicsCRMasyncoperation>), IList<MicrosoftDynamicsCRMduplicaterecord> incidentDuplicateMatchingRecord = default(IList<MicrosoftDynamicsCRMduplicaterecord>), IList<MicrosoftDynamicsCRMphonecall> incidentPhonecalls = default(IList<MicrosoftDynamicsCRMphonecall>), IList<MicrosoftDynamicsCRMconnection> incidentConnections1 = default(IList<MicrosoftDynamicsCRMconnection>), MicrosoftDynamicsCRMbusinessunit owningbusinessunit = default(MicrosoftDynamicsCRMbusinessunit), MicrosoftDynamicsCRMcontact customeridContact = default(MicrosoftDynamicsCRMcontact), MicrosoftDynamicsCRMsubject subjectid = default(MicrosoftDynamicsCRMsubject), MicrosoftDynamicsCRMentitlement entitlementid = default(MicrosoftDynamicsCRMentitlement), IList<MicrosoftDynamicsCRMannotation> incidentAnnotation = default(IList<MicrosoftDynamicsCRMannotation>), IList<MicrosoftDynamicsCRMrecurringappointmentmaster> incidentRecurringAppointmentMasters = default(IList<MicrosoftDynamicsCRMrecurringappointmentmaster>), MicrosoftDynamicsCRMsocialprofile socialprofileid = default(MicrosoftDynamicsCRMsocialprofile), MicrosoftDynamicsCRMsystemuser createdby = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMactivitypointer> incidentActivityPointers = default(IList<MicrosoftDynamicsCRMactivitypointer>), IList<MicrosoftDynamicsCRMbulkdeletefailure> incidentBulkDeleteFailures = default(IList<MicrosoftDynamicsCRMbulkdeletefailure>), MicrosoftDynamicsCRMaccount customeridAccount = default(MicrosoftDynamicsCRMaccount), MicrosoftDynamicsCRMsystemuser owninguser = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMslakpiinstance resolvebykpiid = default(MicrosoftDynamicsCRMslakpiinstance), MicrosoftDynamicsCRMcontact primarycontactid = default(MicrosoftDynamicsCRMcontact), MicrosoftDynamicsCRMcontact responsiblecontactid = default(MicrosoftDynamicsCRMcontact), MicrosoftDynamicsCRMsystemuser createdonbehalfby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMprincipal ownerid = default(MicrosoftDynamicsCRMprincipal), IList<MicrosoftDynamicsCRMletter> incidentLetters = default(IList<MicrosoftDynamicsCRMletter>), IList<MicrosoftDynamicsCRMsyncerror> incidentSyncErrors = default(IList<MicrosoftDynamicsCRMsyncerror>), MicrosoftDynamicsCRMsystemuser modifiedby = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMfax> incidentFaxes = default(IList<MicrosoftDynamicsCRMfax>), MicrosoftDynamicsCRMcontract contractid = default(MicrosoftDynamicsCRMcontract), IList<MicrosoftDynamicsCRMknowledgearticleincident> knowledgearticleIncidents = default(IList<MicrosoftDynamicsCRMknowledgearticleincident>), IList<MicrosoftDynamicsCRMduplicaterecord> incidentDuplicateBaseRecord = default(IList<MicrosoftDynamicsCRMduplicaterecord>), IList<MicrosoftDynamicsCRMtask> incidentTasks = default(IList<MicrosoftDynamicsCRMtask>), MicrosoftDynamicsCRMkbarticle kbarticleid = default(MicrosoftDynamicsCRMkbarticle), IList<MicrosoftDynamicsCRMsharepointdocumentlocation> incidentSharePointDocumentLocations = default(IList<MicrosoftDynamicsCRMsharepointdocumentlocation>), IList<MicrosoftDynamicsCRMteam> incidentTeams = default(IList<MicrosoftDynamicsCRMteam>), MicrosoftDynamicsCRMbcgovApplicationtype bcgovApplicationTypeId = default(MicrosoftDynamicsCRMbcgovApplicationtype), MicrosoftDynamicsCRMcontact bcgovSubmitter = default(MicrosoftDynamicsCRMcontact), MicrosoftDynamicsCRMbcgovCustomaddress bcgovAddressofPersonBusiness = default(MicrosoftDynamicsCRMbcgovCustomaddress), MicrosoftDynamicsCRMbcgovEquipment bcgovAssociatedEquipmentRecord = default(MicrosoftDynamicsCRMbcgovEquipment), IList<MicrosoftDynamicsCRMbcgovCustomproduct> bcgovIncidentCustomproductRelatedApplication = default(IList<MicrosoftDynamicsCRMbcgovCustomproduct>), IList<MicrosoftDynamicsCRMbcgovBusinesscontact> bcgovIncidentBusinesscontact = default(IList<MicrosoftDynamicsCRMbcgovBusinesscontact>), MicrosoftDynamicsCRMbcgovCustomaddress bcgovBCSellersAddress = default(MicrosoftDynamicsCRMbcgovCustomaddress), MicrosoftDynamicsCRMbcgovCustomaddress bcgovOutsideBCSellersAddress = default(MicrosoftDynamicsCRMbcgovCustomaddress), MicrosoftDynamicsCRMbcgovCustomaddress bcgovImportersAddress = default(MicrosoftDynamicsCRMbcgovCustomaddress), MicrosoftDynamicsCRMbcgovCustomaddress bcgovOriginatingSellersAddress = default(MicrosoftDynamicsCRMbcgovCustomaddress), MicrosoftDynamicsCRMbcgovCustomaddress bcgovAddressofBusinessthathasGivenorLoaned = default(MicrosoftDynamicsCRMbcgovCustomaddress), MicrosoftDynamicsCRMbcgovCustomaddress bcgovAddressofBusinessthathasRentedorLeased = default(MicrosoftDynamicsCRMbcgovCustomaddress), IList<MicrosoftDynamicsCRMbcgovLocation> bcgovIncidentLocationAssociatedApplication = default(IList<MicrosoftDynamicsCRMbcgovLocation>), MicrosoftDynamicsCRMbcgovLocation bcgovEquipmentLocation = default(MicrosoftDynamicsCRMbcgovLocation), IList<MicrosoftDynamicsCRMbcgovCertificate> bcgovIncidentBcgovCertificateApplication = default(IList<MicrosoftDynamicsCRMbcgovCertificate>), MicrosoftDynamicsCRMbcgovEquipment bcgovRelatedApplicationsId = default(MicrosoftDynamicsCRMbcgovEquipment), MicrosoftDynamicsCRMbcgovEquipment bcgovEquipmentRecord = default(MicrosoftDynamicsCRMbcgovEquipment))
        {
            ...
            this._bcgovAssociatedequipmentrecordValue = _bcgovAssociatedequipmentrecordValue;
            ...
            BcgovAssociatedEquipmentRecord = bcgovAssociatedEquipmentRecord;
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "_bcgov_associatedequipmentrecord_value")]
        public string _bcgovAssociatedequipmentrecordValue { get; set; }
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "bcgov_AssociatedEquipmentRecord")]
        public MicrosoftDynamicsCRMbcgovEquipment BcgovAssociatedEquipmentRecord { get; set; }
