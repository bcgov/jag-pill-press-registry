...
namespace Gov.Jag.PillPressRegistry.Interfaces.Models
{
    ...
    public partial class MicrosoftDynamicsCRMknowledgebaserecord
    {
        ...
        public IList<MicrosoftDynamicsCRMaccount> AccountKnowledgebaserecord { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "bcgov_customaddress_knowledgebaserecord")]
        public IList<MicrosoftDynamicsCRMbcgovCustomaddress> BcgovCustomaddressKnowledgebaserecord { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "bcgov_inspectionownershipcategory_knowledgebaserecord")]
        public IList<MicrosoftDynamicsCRMbcgovInspectionownershipcategory> BcgovInspectionownershipcategoryKnowledgebaserecord { get; set; }
