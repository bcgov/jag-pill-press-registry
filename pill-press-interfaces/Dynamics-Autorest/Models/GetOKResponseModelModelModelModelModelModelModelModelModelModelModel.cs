...
namespace Gov.Jag.PillPressRegistry.Interfaces.Models
{
    ...
    public partial class GetOKResponseModelModelModelModelModelModelModelModelModelModelModel
    {
        ...
        /// class.
        /// </summary>
        public GetOKResponseModelModelModelModelModelModelModelModelModelModelModel(IList<MicrosoftDynamicsCRMmsdynBcgovCustomaddressKnowledgebasere> value = default(IList<MicrosoftDynamicsCRMmsdynBcgovCustomaddressKnowledgebasere>))
        {
            Value = value;
            CustomInit();
        }
