...
namespace Gov.Jag.PillPressRegistry.Interfaces
{
    ...
    /// </summary>
    public partial interface ISavedqueries
    {
        /// <summary>
        ...
        /// </exception>
        Task<HttpOperationResponse<MicrosoftDynamicsCRMsavedquery>> CreateWithHttpMessagesAsync(MicrosoftDynamicsCRMsavedquery body, string prefer = "return=representation", Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
