...
namespace Gov.Jag.PillPressRegistry.Interfaces
{
    ...
    /// <summary>
    /// Extension methods for Lkbcgovrolecreatedonbehalfby.
    /// </summary>
    public static partial class LkbcgovrolecreatedonbehalfbyExtensions
    {
            /// <summary>
            ...
            /// </param>
            public static MicrosoftDynamicsCRMbcgovRoleCollection Get(this ILkbcgovrolecreatedonbehalfby operations, string ownerid, int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
            ...
            /// </param>
            public static async Task<MicrosoftDynamicsCRMbcgovRoleCollection> GetAsync(this ILkbcgovrolecreatedonbehalfby operations, string ownerid, int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<MicrosoftDynamicsCRMbcgovRole> CreatedonbehalfbyByKeyAsync(this ILkbcgovrolecreatedonbehalfby operations, string ownerid, string bcgovRoleid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.CreatedonbehalfbyByKeyWithHttpMessagesAsync(ownerid, bcgovRoleid, select, expand, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
