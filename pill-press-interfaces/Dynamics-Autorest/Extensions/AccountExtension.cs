...
namespace Gov.Jag.PillPressRegistry.Interfaces
{
    ...
    public partial class Accounts : IServiceOperations<DynamicsClient>, IAccounts
    {
        ...
        /// </return>
        /// 
        public async Task<HttpOperationResponse> RemoveReferenceWithHttpMessagesAsync(string accountId, string fieldname, string removeId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (accountId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "accountId");
            ...
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "accounts({accountId})/{fieldname}({removeId})/$ref").ToString();

            if (removeId == null)
            {
                _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "accounts({accountId})/{fieldname}/$ref").ToString();
            }
            else
            {
    ...
    public partial interface IAccounts
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<HttpOperationResponse> RemoveReferenceWithHttpMessagesAsync(string accountId, string fieldname, String removeId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
