...
namespace Gov.Jag.PillPressRegistry.Interfaces
{
    ...
    /// </summary>
    public partial interface ICustomaddressincidentcivicaddressofpurchaser
    {
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<HttpOperationResponse<MicrosoftDynamicsCRMincident>> CivicAddressofPurchaserByKeyWithHttpMessagesAsync(string bcgovCustomaddressid, string incidentid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
