...
namespace Gov.Jag.PillPressRegistry.Interfaces
{
    ...
    /// </summary>
    public partial interface IActregulationreferences
    {
        /// <summary>
        ...
        /// </exception>
        Task<HttpOperationResponse<MicrosoftDynamicsCRMbcgovActregulationreference>> CreateWithHttpMessagesAsync(MicrosoftDynamicsCRMbcgovActregulationreference body, string prefer = "return=representation", Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
