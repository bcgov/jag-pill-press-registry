...
namespace Gov.Jag.PillPressRegistry.Interfaces
{
    ...
    /// <summary>
    /// Extension methods for Lkbcgovinspectionownershipcategorymodifiedonbehalfby.
    /// </summary>
    public static partial class LkbcgovinspectionownershipcategorymodifiedonbehalfbyExtensions
    {
            /// <summary>
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<MicrosoftDynamicsCRMbcgovInspectionownershipcategory> ModifiedonbehalfbyByKeyAsync(this ILkbcgovinspectionownershipcategorymodifiedonbehalfby operations, string ownerid, string bcgovInspectionownershipcategoryid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ModifiedonbehalfbyByKeyWithHttpMessagesAsync(ownerid, bcgovInspectionownershipcategoryid, select, expand, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
