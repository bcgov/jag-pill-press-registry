...
namespace Gov.Jag.PillPressRegistry.Interfaces
{
    ...
    public static partial class IncidentbusinesscontactsetExtensions
    {
            ...
            /// </param>
            public static MicrosoftDynamicsCRMbcgovIncidentBusinesscontactCollection Get(this IIncidentbusinesscontactset operations, int? top = default(int?), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
            ...
            /// </param>
            public static async Task<MicrosoftDynamicsCRMbcgovIncidentBusinesscontactCollection> GetAsync(this IIncidentbusinesscontactset operations, int? top = default(int?), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
