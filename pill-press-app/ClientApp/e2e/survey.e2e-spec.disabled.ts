...
describe('App Survey Page', () => {
    ...
    it('should display a title', async () => {
      ...
      expect(heading).toEqual('What does an applicant need to apply for a pill press licence?');
    });

    it('should load the survey configuration file', async () => {
        console.log('surveyConfig title is ' + surveyConfig.title);
        expect(surveyConfig.title).toEqual('What does an applicant need to apply for a pill press licence?');
