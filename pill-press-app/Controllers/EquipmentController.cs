...
namespace Gov.Jag.PillPressRegistry.Public.Controllers
{
    ...
    public class EquipmentController : Controller
    {
        ...
        public EquipmentController(IConfiguration configuration, IDynamicsClient dynamicsClient, IHttpContextAccessor httpContextAccessor, ILoggerFactory loggerFactory, IWebHostEnvironment env)
        {
